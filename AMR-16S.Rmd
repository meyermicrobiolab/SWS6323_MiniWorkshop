...
This tutorial is not as easy to use as the DADA2 tutorial. There are many options for customization, but this tutorial does not list out what the options mean, as I frequently see with programs you would run on the command line.
